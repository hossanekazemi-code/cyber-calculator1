...
def get_lan_ip() -> str:
    """Best-effort detection of the PC's LAN IPv4 address."""
    sock = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    try:
        # No packet needs to be sent; this selects the active route/interface.
...
def open_browser_when_ready() -> None:
    """Wait until Flask is listening, then open the local page automatically."""
